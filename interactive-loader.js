...
(function(){
  ...
  async function start(){
    ...
    if(cardQuery.get('open')==='map' && cardQuery.get('routeId')){
      loadOne('map',{timeout:10000}).then(()=>{if(typeof window.showGameSection==='function')window.showGameSection('map',null)}).catch(e=>console.warn('[BUSPHOTO] card map open',e));
    }
