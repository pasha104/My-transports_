...
(function(){
  ...
  window.openInteractiveSection=async function(section,btn){
    try{
      ...
      if(typeof window.showGameSection==='function'){const p=window.__BUSPHOTO_PENDING_SECTION__;window.__BUSPHOTO_PENDING_SECTION__=null;window.showGameSection(p?.section||section,p?.btn||btn);refreshSectionData(p?.section||section);}
