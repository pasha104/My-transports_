(function(){
  ...
  function panel(){
    ...
    p.innerHTML=''+
      ...
      '<div class="bp-cloud-actions"><button type="button" id="bpCloudRefresh">🔄 Синхронизировать</button><button type="button" id="bpCloudCopy">📋 Скопировать код</button></div>';
  ...
  async function register(){
    const data=await json('/api/players/register',{method:'POST',body:JSON.stringify({playerId:makeId(),state:localState()})});
