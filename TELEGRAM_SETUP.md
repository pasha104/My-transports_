...
ВАЖНО: эта версия не перезаписывает существующий локальный прогресс сервера значениями по умолчанию. Если после первого подключения сервер показывает 50 000 ₽/0 ТС, а на телефоне сохранены старые данные, нажмите «🛟 Восстановить данные с телефона».
